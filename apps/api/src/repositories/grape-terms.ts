...
const grapeGroups: readonly (readonly string[])[] = [
  ...
  ["Parellada"],
  ["Bobal"],
  ["Graciano", "Morrastel", "Tintilla"],
  ["Mónica", "Monica"],
  ["Airén"],
  ["Moscatel", "Muscat", "Moscato", "Muskateller", "Zibibbo", "Moscatel de Alejandría"],
  ["Pedro Ximénez", "Pedro Ximenez", "PX"],
  ["Loureiro"],
  ["Treixadura", "Trajadura"],
  ["Caíño", "Caino", "Borraçal"],
  ["Sousón", "Souson", "Vinhão", "Vinhao"],
  ["Prieto Picudo"],
  ["Listán Negro", "Listan Negro"],
  ["Baga"],
  ["Castelão", "Castelao", "Periquita"],
  ...
  ["Arinto", "Pedernã"],
  ["Encruzado"],
  ["Fernão Pires", "Fernao Pires", "Maria Gomes"],
  ["Nero d'Avola", "Nero d Avola", "Calabrese"],
  ["Aglianico"],
  ["Montepulciano"],
  ["Barbera"],
  ["Dolcetto"],
  ...
  ["Lambrusco"],
  ["Vermentino", "Rolle", "Favorita", "Pigato"],
  ["Fiano"],
  ["Greco"],
  ["Cortese"],
  ["Garganega"],
  ...
  ["Zweigelt"],
  ["St. Laurent", "Saint Laurent", "Sankt Laurent"],
  ["Sagrantino"],
  ["Torrontés", "Torrontes"],
  ["País", "Pais", "Mission", "Listán Prieto"],
  ["Pinotage"],
  ["Assyrtiko"],
  ["Xinomavro"],
  ["Agiorgitiko"],
